...
from heartdisease_model import __version__ as model_version
from heartdisease_model.predict import make_prediction
...
async def predict(input_data: schemas.MultipleHeartDiseaseInputs) -> Any:
    """
